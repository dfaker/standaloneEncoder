...
maxVWidth = 1280
minVWidth = 0
includeCornerLogo=True
# CHANGE THE ABOVE OPTIONS
...
q = Queue()
t = threading.Thread(target=processClips,args=(q,),daemon=True)
...
for filename in sys.argv[1:]:
  ...
  q.put(((None,filename,0,duration),(includeCornerLogo,(None,None)),(0,0,0,0),(fpsLimit,sizeLimit,audioBR,videoBrMax,maxVWidth,minVWidth)))
